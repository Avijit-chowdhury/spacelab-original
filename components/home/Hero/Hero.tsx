    ...
    <section className="hero flex items-center">
      ...
      <div className="container mx-auto relative">
        <div className="flex flex-col-reverse lg:flex-row mx-auto">
          ...
          <h1 className="c-white font-semibold" style={{ fontSize: 34  }}>
            Embark on an adventure with<br />Space<span className="c-main" style={{color: "red"}} >Budz.</span>  Where will yours take you?
                  </h1>
                  <br /><br />
            <DelegateButton
              data-aos="fade-up"
